...
export const deleteTodolistAC = createAction<{id: string}>('todolists/deleteTodolist') // TODO Параметры: сначала название редьюсера, потом что будет делать этот action
